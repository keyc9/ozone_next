...
export default function Header() {
  ...
  const { isOpen, setIsOpen, addToCart, cartItems, deleteCartItem } = useCart();
            ...
            {cartItems.map(product => (
              <div className="card" key={product.id}>
                ...
                <div className="card-body justify-content-between">
                  <div className="card-price">{product.price} руб * {product.count} = {product.price * product.count} руб</div>
