                ...
                <div className="row no-gutters goods">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      <div className="card-img-wrapper">
                        ...
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1033180284.jpg')"
                        ></span>
                      </div>
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      ...
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1027495663.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1024358491.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      ...
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1024822131.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1021386685.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      ...
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1024928305.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      ...
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1021877092.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div className="card">
                      <div className="card-img-wrapper">
                        <span className="card-img-top"
                        // style="background-image: url('https://cdn1.ozone.ru/multimedia/c400/1025222877.jpg')"
                        ></span>
                      </div>
                      <div className="card-body justify-content-between">
